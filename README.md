...
- 中央社科技 RSS（篩選 AI 主題）
- 科技新報科技教育 RSS（篩選 AI 主題）
- TWCERT/CC 資安新聞 RSS（篩選 AI 主題）
...
首頁只顯示標題含中文字的消息。英文新聞、英文社群貼文與英文影片即使成功抓取，也不會進入最新消息版位。

消息會依內容分成「教育現場、政策治理、資安風險、工具應用、產業趨勢」五類。涉及校園、學生、政策、個資、漏洞或攻擊的內容會標示為「重要」，規則由程式判斷，不交給 AI 猜測。
...
- 原始標題必須含中文字才會進入摘要與展示流程，避免英文消息出現在首頁。
